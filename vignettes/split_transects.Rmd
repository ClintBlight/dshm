...
#devtools::use_data(transects,segments,segments_1km,segments_1km_1s,segments_nocap,intersections,cor_seg,depth_crop,DC_crop,DR_crop,land_crop,overwrite=TRUE)
...
```{r, echo=FALSE, out.width = "300px", fig.show='hold'}
raster::plot(segments,main="With cap")
raster::plot(segments_nocap,main="No cap")
```
...
As you notice, the coast is highly convoluted and many buffered segments have overlapping areas with land. 
