...
#devtools::use_data(transects,segments,segments_2km,segments_2km_1s,segments_2km_par,segments_2km_par_nocap,intersections,cor_seg,depth_crop,DC_crop,DR_crop,land_crop,cor_seg_final_all,cor_seg_final,empty_grid,grid_final_all,grid_final,overwrite=TRUE)
